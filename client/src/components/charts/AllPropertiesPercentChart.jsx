...
const RentIncreaseChart = (props) => {
  ...
  const getRentIncreaseAverages = (prices, properties) => {
    ...
    // Loop through that data to get the average increase per year
    ...
    for (let i = 2015; i <= 2023; i++) {
      ...
      rentIncreaseAverages[i] =
        Math.round((sum / allIncreasesPerYear[i].length) * 100) / 100;
    }

    return rentIncreaseAverages;
  };

  console.log(getRentIncreaseAverages(prices, properties));
